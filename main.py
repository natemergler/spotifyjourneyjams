...
def print_artist_info(main_artist, verify_songs):
    ...
    if len(verify_songs['tracks']) >= 2:
        print(f"{artist_name} has made classics like {verify_songs['tracks'][0]['name']} and {verify_songs['tracks'][1]['name']}")
    elif len(verify_songs['tracks']) == 1:
        print(f"{artist_name} made the classic {verify_songs['tracks'][0]['name']}")
    else:
